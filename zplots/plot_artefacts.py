...
ax1.plot(xs, tilde_f_o_g(xs), color = u'gray', label=r"$\widetilde{f\circ g}$")
...
ax3.plot(xs, c11(xs), '--', label=r'$f_1 \circ g_1$', alpha=0.7)
ax3.plot(xs, c12(xs), '--', label=r'$f_1 \circ g_2$', alpha=0.7)
ax3.plot(xs, c21(xs), '--', label=r'$f_2 \circ g_1$', alpha=0.7)
ax3.plot(xs, c22(xs), '--', label=r'$f_2 \circ g_2$', alpha=0.7)
...
ax2.plot(xs, f_sm(g_sm(xs)), color = u'gray', alpha = 0.7, label=r'$\tilde{f}\circ \tilde{g}$')
plt.setp(ax2.get_xticklabels(), visible=False)
plt.setp(ax2.get_yticklabels(), visible=False)
# =============================
ax4 = fig.add_subplot(224, sharex = ax2)
ax4.plot(xs, nc11(xs), '--', label=r'$f_1 \circ g_1$', alpha=0.7)
ax4.plot(xs, nc12(xs), '--', label=r'$f_1 \circ g_2$', alpha=0.7)
ax4.plot(xs, nc21(xs), '--', label=r'$f_2 \circ g_1$', alpha=0.7)
ax4.plot(xs, nc22(xs), '--', label=r'$f_2 \circ g_2$', alpha=0.7)
...
plt.show()
# plt.savefig("/home/seb/Desktop/write/smoothing/content/figures/artefact_vs_proper.pgf")
